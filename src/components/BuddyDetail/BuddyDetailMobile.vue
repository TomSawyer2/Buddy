            ...
            <v-container>
                <v-row>
                    <v-col cols="12" sm="6" md="6">
                        ...
                        <span class="ml-2"> {{ userInfo.phoneNumber ? userInfo.phoneNumber : "暂无"}} </span>
                    </v-col>
                    <v-col cols="12" sm="6" md="6">
                        <h3 class="font-weight-light font_title">性别</h3>
                        <span class="ml-2"> {{ userInfo.sex ? userInfo.sex : "暂无"}} </span>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12" sm="6" md="6">
                        <h3 class="font-weight-light font_title">队员编号</h3>
                        <span class="ml-2"> {{ userInfo.number ? userInfo.number : "暂无"}} </span>
                    </v-col>
                    <v-col cols="12" sm="6" md="6">
                        <h3 class="font-weight-light font_title">出生日期</h3>
                        <span class="ml-2"> {{ userInfo.birthday ? userInfo.birthday : "暂无"}} </span>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12" sm="12" md="12">
                        <h3 class="font-weight-light font_title">毕业年月</h3>
                        <span class="ml-2"> {{ userInfo.graduateTime ? userInfo.graduateTime : "暂无"}} </span>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12" sm="12" md="12">
                        <h3 class="font-weight-light font_title">工作所在城市</h3>
                        <span class="ml-2"> {{ userInfo.location ? userInfo.location : "暂无"}} </span>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12" sm="12" md="12">
                        <h3 class="font-weight-light font_title">身份</h3>
                        <span class="ml-2"> {{ userInfo.identity ? userInfo.identity : "暂无"}} </span>
                    </v-col>
                </v-row>
                <v-row v-if="userInfo.isGraduated == '是' ? true : false">
                    <v-col cols="12" sm="12" md="12">
                        <h3 class="font-weight-light font_title">在站</h3>
                        <span class="ml-2"> {{ userInfo.substation ? userInfo.substation : "暂无"}} </span>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12" sm="12" md="12">
                ...
                <v-row>
                    <v-col cols="12" sm="12" md="12">
                        ...
                        <span class="ml-2"> {{ userInfo.highSchool ? userInfo.highSchool : "暂无"}} </span>
                    </v-col>
                </v-row>
                ...
                <v-row>
                    <v-col cols="12" sm="6" md="6">
                        ...
                        <span class="ml-2"> {{ userInfo.character ? userInfo.character : "暂无"}} </span>
                    </v-col>
                    <v-col cols="12" sm="6" md="6">
                        <h3 class="font-weight-light font_title">性格测试结果</h3>
                        <span class="ml-2"> {{ userInfo.characterResult ? userInfo.characterResult : "暂无"}} </span>
                    </v-col>
                </v-row>
            </v-container>
        </v-card-text>
...
export default Vue.extend({
  ...
  mounted () {
      if((this as any).userInfo.graduateYear && (this as any).userInfo.graduateMonth) {
        (this as any).graduateTime = (this as any).userInfo.graduateYear + '年' + (this as any).userInfo.graduateMonth + '月';
      }
  }
});
</script>
